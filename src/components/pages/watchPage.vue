<template>
    <div :class="['watchPageBox',{'watchPageBoxB':(showSubmitMvBox||loading)}]">
        ...
        <div :class="[hasInfo? '':'noMvInfo']">
          <el-upload class="videoBox" drag :multiple="false" :auto-upload="false" :on-change="handleChange" action="/" :show-file-list="false">
            <div class="uploadTips">{{hasInfo?'':'将视频文件拖动到播放窗口，或点击这里可以手动选择视频文件'}}</div>
